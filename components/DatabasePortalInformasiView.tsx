    ...
    <div className="flex-1 flex flex-col gap-6">
      ...
      {statusMessage && (
        <div className={`p-4 rounded-xl border text-sm font-medium flex items-center justify-between gap-3 shadow-sm ${
          statusMessage.type === 'success' ? 'bg-blue-50 border-blue-200 text-blue-800' :
          statusMessage.type === 'error' ? 'bg-rose-50 border-rose-200 text-rose-800' :
          'bg-slate-100 border-slate-300 text-slate-800'
        }`}>
          <div className="flex items-center gap-2">
            {statusMessage.type === 'success' ? <CheckCircleIcon className="w-5 h-5 text-blue-600 shrink-0" /> : <InfoIcon className="w-5 h-5 text-slate-600 shrink-0" />}
            ...
            {showModularOptions && (
              <div className="mt-3 pt-3 border-t border-slate-200 grid grid-cols-2 sm:grid-cols-3 gap-2">
                ...
                <button
                  ...
                  className="p-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-medium text-left flex items-center gap-1.5 cursor-pointer"
                >
                  <TeacherIcon className="w-3.5 h-3.5 text-blue-600" />
                  <span>Data Guru</span>
                </button>
                <button
                  type="button"
        ...
        <Card className="p-5 bg-white/90 border border-slate-200/80 shadow-sm rounded-2xl flex flex-col justify-between">
          <div>
            ...
            >
              ...
              <UploadIcon className={`w-8 h-8 mb-1.5 ${selectedFile ? 'text-blue-600' : 'text-slate-400'}`} />
            ...
            {validationResult && (
              <div className="mt-3">
                {validationResult.valid ? (
                  <div className="p-3 rounded-xl bg-blue-50/80 border border-blue-200 text-xs space-y-2 text-blue-900">
                    <div className="flex items-center gap-1.5 font-bold text-blue-800">
                      <CheckCircleIcon className="w-4 h-4 text-blue-600" />
                      <span>Berkas Valid: {validationResult.summary?.schoolName}</span>
                    </div>
                    <div className="text-[11px] text-slate-600 grid grid-cols-2 gap-1 bg-white/70 p-2 rounded border border-blue-100 text-blue-900">
          ...
          <div className="mt-4">
            <button
              ...
              className="w-full py-3 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-bold text-sm shadow-sm flex items-center justify-center gap-2 transition-colors cursor-pointer"
            >
              {isRestoring ? (
                <>
                    ...
                    <td className="py-2.5 px-3 text-right whitespace-nowrap">
                      <div className="inline-flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className="py-1 px-2 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold transition-colors cursor-pointer"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md animate-fadeIn">
          <div className="bg-slate-900 border border-slate-700/80 rounded-3xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden text-slate-100">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Struktur Folder Vault Database: <span className="font-mono text-indigo-300">/database_portalinformasi</span> &bull; Checksum: <span className="font-mono text-blue-400">{inspectingPackage.metadata.checksum}</span>
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 bg-slate-950 flex items-center justify-between border-b border-slate-800 text-xs">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-1 rounded-lg bg-blue-500/10 text-blue-400 font-mono border border-blue-500/20 font-bold">
